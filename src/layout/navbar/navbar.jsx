...
function navbar() {
  return (
    <nav className="flex items-center justify-between max-w-[1320px] w-[84%] mx-auto my-[8px]">
      <Link className="text-[#cd5ff8] font-bold text-[27px]" to="/">Porfolio.</Link>
      <ul className="text-white flex">
        <li>
          <Link to="/" className="px-4 py-3 flex items-center text-[20px] gap-[6px]">
            <svg
              stroke="currentColor"
              fill="currentColor"
        ...
        <li>
          <Link to="/about" className="px-4 py-3 flex items-center text-[20px] gap-[6px]">
            <svg
              stroke="currentColor"
              fill="currentColor"
              viewBox="0 0 1024 1024"
        ...
        <li>
          <Link
            to="/projects"
            className="px-4 py-3 flex items-center text-[20px] gap-[6px]"
          >
            <svg
              stroke="currentColor"
              fill="currentColor"
      ...
      <div className="fork-btn bg-[#934cce5e] border border-[#934cce5e]  py-[6px] px-[21px] rounded-[4px]">
        <Link
          className="flex"
          to="https://github.com/cumsud-ismayilov/ReactPortfolio"
        >
          <svg
            stroke="currentColor"
            fill="none"
